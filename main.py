...
#
# After importing the modules, we will now then create
...
#
# After creating the Main Frame we will now add
...
#
# Then after setting up the design we will
...
# Creating The Main Function This is the where main function located within the
# program. The program itself can add, view, and search all the products from the database.
...
#
# After finishing the function save the application as 'index.py'. This function
# will run the code and check if the main is initialize properly.
# To do that copy the code below and paste it inside the IDLE text editor.

#========================================INITIALIZATION===================================
if __name__ == '__main__':
    root.mainloop()

# There you have it we successfully created a Simple Inventory System Using Python / SQLite.
# I hope the this simple program help you for what you are looking for.
# For more updates and tutorials. Just kindly visit this site. Enjoy Coding!!!
